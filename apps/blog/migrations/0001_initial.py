# Generated by Django 4.2.2 on 2023-12-16 15:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=255, verbose_name='Описание категории')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', models.ImageField(blank=True, upload_to='images/thumbnails/', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=('.png', 'jpg', 'webp', 'jpeg', 'gif'))], verbose_name='Изображение записи')),
                ('status', models.CharField(choices=[('published', 'Опубликованный'), ('draft', 'Черновик')], default='published', max_length=10, verbose_name='Стаутс записи')),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['-fixed', '-create', 'status'], name='blog_posts_fixed_e1ada1_idx')],
            },
        ),
    ]
